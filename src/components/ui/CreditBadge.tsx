...
export default function CreditBadge ({ initialBalance }: CreditBadgeProps): ReactNode {
  ...
  return (
    <div
      className={`flex items-center gap-2 rounded-full bg-gradient-to-br from-golden-fizz-300 via-golden-fizz-400 to-golden-fizz-500 px-4 py-2 shadow-lg shadow-golden-fizz-500/30 ring-2 ring-golden-fizz-600/40 transition-all duration-300 ${
    ...
    >
      <svg
        ...
        viewBox='0 0 24 24'
        fill='currentColor'
        className={`h-5 w-5 text-golden-fizz-800 ${isAnimating ? 'animate-spin' : ''}`}
      >
      ...
      <span className='text-lg font-bold text-golden-fizz-900'>{displayCredit}</span>
    </div>
  )
}
